<x-app-layout>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add a new Jurusan</h2>
                ...
                <form action="{{ route('jurusans.store') }}" method="POST">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div class="sm:col-span-2">
                            <label for="name_cat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jurusan Name</label>
                        ...
                        <div class="sm:col-span-2">
                            <label for="desc_cat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
