                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody> 
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ $siswa->created_at }}</td>
                                <td class="px-4 py-3">
                                    <img src="{{ asset('storage/products/' . $siswa->foto) }}" alt="Foto" width="100">
                                    </td>
                                    <td class="px-4 py-3">
                                    <img src="{{ asset('storage/siswas/' . $siswa->scan_kk) }}" alt="kk" class="rounded" style="width: 150px">
                                    </td>
